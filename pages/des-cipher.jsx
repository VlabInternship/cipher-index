      ...
      <div className="max-w-6xl mx-auto">
        ...
        {activeTab === "theory" && (
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">What is DES?</h2>
            <div className="prose max-w-none text-gray-700">
              <p className="mb-4">
                DES is a 64-bit block, 56-bit key, symmetric Feistel cipher with 16 rounds.
                Each round computes <em>f(R, K)</em> = P(S(E(R) ⊕ K)).
              </p>
              <h3 className="text-xl font-semibold mb-2">Encryption flow</h3>
              <ol className="list-decimal list-inside space-y-1 mb-4">
                <li>Initial Permutation (IP), split into L₀ and R₀</li>
                <li>For r = 1..16: Lᵣ = Rᵣ₋₁; Rᵣ = Lᵣ₋₁ ⊕ f(Rᵣ₋₁, Kᵣ)</li>
                <li>Final swap (R₁₆‖L₁₆), then Final Permutation (IP⁻¹)</li>
              </ol>
              <h3 className="text-xl font-semibold mb-2">Decryption</h3>
              <p>Same structure with subkeys in reverse order: K₁₆ … K₁.</p>
            </div>
          </div>
        )}
